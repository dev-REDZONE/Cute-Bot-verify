...
module.exports = {
	...
	run: async (client, message, args, user, text, prefix) => {
			message.channel.send(new MessageEmbed()
				...
				.addField("Source Code. ", "Don't just use the source for yourself,... please [ invite ](https://discord.com/api/oauth2/authorize?client_id=828921463348264982&permissions=0&scope=bot) me too![\`Click here\`](https://discord.com/api/oauth2/authorize?client_id=828921463348264982&permissions=0&scope=bot)")
			        .addField("Source Code. ", "[ My git hub ](https://github.com/Devjano) link git hub ![\`Click here\`](https://github.com/Devjano)")
				
				.setColor(config.colors.yes)
				.setFooter("Calms| by: jano", client.user.displayAvatarURL())
			);
	}
}
